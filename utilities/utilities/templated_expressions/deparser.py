...
@deparse_expression.register(TemplatedVariable)
def deparse_expression_templated_variable(self: TemplatedVariable):
    return self.name.deparse()


@deparse_expression.register(TemplatedFunctionSum)
def deparse_expression_templated_function_sum(self: TemplatedFunctionSum):
    return f"$sum{{{deparse_expression(self.templated_expression)}, [{', '.join(map(str, self.labels))}]}}"


@deparse_expression.register(TemplatedFunctionMean)
def deparse_expression_templated_function_mean(self: TemplatedFunctionMean):
    return f"$mean{{{deparse_expression(self.templated_expression)}, [{', '.join(map(str, self.labels))}]}}"
